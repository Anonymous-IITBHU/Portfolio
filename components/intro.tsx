  ...
  return (
    ...
    >
      ...
      >
        ...
        I&apos;m a <b className="font-bold">full-stack developer</b> and {" "}
        <b className="font-bold">Competetive Programmer</b>. I enjoy building{" "}
        <b className="italic">sites and apps</b>. My focus is{" "}
        <b className="font-bold">Learning new tools.</b>
      </motion.h1>
